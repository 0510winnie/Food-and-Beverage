...
class PermissionController extends Controller
{
            ...
            foreach ($crud as $x )
             {
              ...
              $description = "Allow a user to " . strtoupper($x) . "a/ an" . ucwords($request->resource);

              $permission = new Permission();
              $permission->name = $slug;
              $permission->display_name = $display_name;
              $permission->description = $descritpion;
              $permission->save();
             }
             return redirect()->route('permissions.index');
    ...
    public function update(Request $request, $id)
    {
       ...
       Session::flash('success', 'Succefully Updated the ' . $permission->display_name . ' Permission.');
